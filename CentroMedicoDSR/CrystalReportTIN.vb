...
Public Class CrystalReportTIN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CentroMedicoDSR.CrystalReportTIN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportTIN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportTIN = New CrystalReportTIN()
        rpt.Site = Me.Site
        Return rpt
    End Function
