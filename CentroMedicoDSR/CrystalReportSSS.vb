...
Public Class CrystalReportSSS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CentroMedicoDSR.CrystalReportSSS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportSSS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportSSS = New CrystalReportSSS()
        rpt.Site = Me.Site
        Return rpt
    End Function
