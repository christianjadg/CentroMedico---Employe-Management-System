...
Public Class CrystalReportUMID
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CentroMedicoDSR.CrystalReportUMID.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportUMID
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportUMID = New CrystalReportUMID()
        rpt.Site = Me.Site
        Return rpt
    End Function
